  ...
  return (
    <>
              ...
              return(
                <tr key={index}>
                  ...
                  <td className={profclass}>
                    {stock.avg > 0 ? (((stock.price - stock.avg) / stock.avg) * 100).toFixed(2) + "%" : "0.00%"}
                  </td>
                  <td className={dayclass}>
                    {typeof stock.day === "number" ? (stock.day >= 0 ? "+" : "") + stock.day.toFixed(2) + "%" : "+0.00%"}
                  </td>
                </tr>
              );
            })}
      ...
      <div className="row">
        ...
        <div className="col">
          <h5>{totalCurrInvestment.toFixed(2)}</h5>
          <p className="bold-text">Current value</p>
        </div>
        <div className="col">
          <h5 className={totalprofclass}>
            {totalProfit.toFixed(2)} ({totalInvestment > 0 ? ((totalProfit/totalInvestment)*100).toFixed(2) : '0.00'}%)
          </h5>
          <p className="bold-text">P&L</p>
        </div>
      </div>
